    ...
    overlay.innerHTML = `
      <div class="bg-zinc-900 border border-white/10 rounded-3xl p-6 max-w-xl w-full max-h-[90vh] overflow-y-auto">
        ...
        <div class="text-sm text-zinc-400 mb-4">
          Copy one command into ${uiCopy.runShell}. It downloads the audio, separates 6 stems with native Demucs, and uploads to your Drive.
        ...
        <div class="space-y-3 text-sm">
          ...
          <div>
            <div class="text-xs font-medium text-zinc-300 mb-1">2. Paste this in ${uiCopy.runShell} and press Enter</div>
